package com.joohnq.core.ui.adapter
...
abstract class LESEAdapter<T, VHNothing: ViewHolder, VHLoading: ViewHolder, VHEmpty: ViewHolder, VHSuccess: ViewHolder, VHError: ViewHolder>:
				Adapter<ViewHolder>() {
